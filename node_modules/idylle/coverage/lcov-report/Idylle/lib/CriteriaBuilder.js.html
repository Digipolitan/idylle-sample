...
<html lang="en">
<head>
    <title>Code coverage report for Idylle/lib/CriteriaBuilder.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">Idylle/lib/</a> CriteriaBuilder.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    buildFields(query, criteria) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!query.fields)
            return criteria;
&nbsp;
<span class="cstat-no" title="statement not covered" >        criteria.fields = query.fields;</span>
...
&nbsp;
    ...
    buildSort(query, criteria) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!query.sort)
            return criteria;
&nbsp;
<span class="cstat-no" title="statement not covered" >        criteria.sort = query.sort;</span>
<span class="cstat-no" title="statement not covered" >        return criteria;</span>
    }
&nbsp;
    /**
    ...
    buildWhere(query, criteria) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!query.where)
            return criteria;
&nbsp;
<span class="cstat-no" title="statement not covered" >        criteria.where = query.where;</span>
<span class="cstat-no" title="statement not covered" >        return criteria;</span>
    }
&nbsp;
    /**
...
&nbsp;
            else <span class="missing-if-branch" title="else path not taken" >E</span>if (query.toString() === '[object Object]') {
                for (let item in query) {
                    <span class="missing-if-branch" title="else path not taken" >E</span>if (query.hasOwnProperty(item)) {
                        criteria.path += `${item}`;
...
&nbsp;
&nbsp;
module.exports = CriteriaBuilder;</pre></td></tr>
</table></pre>
