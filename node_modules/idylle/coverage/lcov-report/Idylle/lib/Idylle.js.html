...
<html lang="en">
<head>
    <title>Code coverage report for Idylle/lib/Idylle.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">Idylle/lib/</a> Idylle.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
        function attachCacheToAction() {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (!self.cache)
...
&nbsp;
        function load(component) {
            ...
            return promises ? Promise.all(promises) : <span class="branch-1 cbranch-no" title="branch not covered" >Promise.resolve();</span>
        }
    }
&nbsp;
    start() {
...
&nbsp;
        else <span class="missing-if-branch" title="if path not taken" >I</span>if (event === Idylle.events.init.models)
<span class="cstat-no" title="statement not covered" >            this.add(listener, event, this.models);</span>
&nbsp;
        else <span class="missing-if-branch" title="if path not taken" >I</span>if (event === Idylle.events.init.cache)
<span class="cstat-no" title="statement not covered" >            this.add(listener, event, this.cache);</span>
&nbsp;
        else <span class="missing-if-branch" title="if path not taken" >I</span>if (event === Idylle.events.init.dependencies)
<span class="cstat-no" title="statement not covered" >            this.add(listener, event, undefined);</span>
        else
...
<span class="cstat-no" title="statement not covered" >        this.name = 'InvalidServerError';</span>
<span class="cstat-no" title="statement not covered" >        this.message = `expecting function server got ${typeof fn} \n ${this.stack}`</span>
    }
}</pre></td></tr>
</table></pre>
